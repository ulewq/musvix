...
public class Logingui {
	...
	private void initialize() {
		...
		sign_up_button.setIcon(new ImageIcon(Logingui.class.getResource("/login/signup_button.png")));
		...
		log_in_button.setIcon(new ImageIcon(Logingui.class.getResource("/login/login1_button.png")));
		...
		exit_button.setIcon(new ImageIcon(Logingui.class.getResource("/login/exit_button.png")));
		...
		minimal_button.setIcon(new ImageIcon(Logingui.class.getResource("/login/minimal_button.png")));
